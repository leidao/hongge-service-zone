      ...
      <div class="w-100% h-100% relative">
        ...
        <div class="absolute left-0px top-0px z-12 w-100% flex justify-center items-center">
          <div class="w-356px h-104px wrap_bg_title relative">
            <span class="absolute left-100px top-3px text-#6CFFCB text-18px font-700">当日用电碳排放总量</span>
            <div class="text-#fff text-52px absolute left-0px top-16px w-356px text-center">463,829</div>
