...
export default class Viewer {
  ...
  initScene() {
    ...
    this.camera.position.set(-32.38, 32.6, -36.49)
    /** 创建渲染器 */
    ...
    /** 创建光照 */
    // const ambientLight1 = new THREE.AmbientLight(config.AMBIENT_LIGHT_COLOR, 1.5)
      ...
      (gltf) => {
        ...
        this.gltfLoader.load(
          ...
          (gltf) => {
            ...
            // const colorTexture = textureLoader.load('color-map.jpg')
            // const normalTexture = textureLoader.load('normal-map.jpg')
            // const alphaTexture = textureLoader.load('alpha-map.png')
            // const roughnessTexture = textureLoader.load('roughness-map.jpg')

            // // 设置材质
            // treeMaterial.map = colorTexture
            // treeMaterial.normalMap = normalTexture
            // treeMaterial.alphaMap = alphaTexture
