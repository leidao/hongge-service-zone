 ...
 * @LastEditors: ldx
 * @LastEditTime: 2025-01-02 15:05:52
-->
<template>
  <div class="h-100%">
    <slot name="extra" ref="extraSlot" />
    <div class="exterior_shell bg-#3a446db3" :style="{ height: `calc(100% - ${props.height?.extra})` }">
      <div class="flex items-center">
        <div class="dot"></div>
        <div class="flex-1 mx-6px h-2px bg-#3a446d"></div>
        <div class="dot"></div>
      </div>
